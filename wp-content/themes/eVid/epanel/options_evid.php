...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		.post-info2 { color: #<?php echo(get_option($shortname.'_postinfo_color')); ?>; }
		a:link, a:visited { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		#pages ul li a:link, #pages ul li a:visited, #pages ul li a:active { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		.sidebar-box h2 { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		.post-title { color:#<?php echo(get_option($shortname.'_color_heading')); ?>; }
	</style>
